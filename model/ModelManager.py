...
class ModelManager(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.__num_slot = config.tag_pad_idx
        self.__num_intent = config.num_tags
        ...
        self.__intent_decoder = LSTMDecoder(
            ...
            config.hidden_size,
            self.__num_intent, config.dropout,
        ...
        self.__slot_decoder = LSTMDecoder(
            config.hidden_size, + config.attention_size,
            config.hidden_size,
            self.__num_slot, config.dropout,
            embedding_dim=config.embed_size,
    ...
    def forward(self, batch, n_predicts=None, forced_slot=None, forced_intent=None):
