...
# print(Example.word_vocab.vocab_size)
args.pad_idx = Example.word_vocab[PAD]
# print(Example.word_vocab[PAD])
args.num_tags = Example.label_vocab.num_tags
# print(Example.label_vocab.num_tags)
args.tag_pad_idx = Example.label_vocab.convert_tag_to_idx(PAD)
# print(Example.label_vocab.convert_tag_to_idx(PAD))
