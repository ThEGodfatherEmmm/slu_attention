...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--modelroot', default='../trained_model/', help='root of data')
    ...
    arg_parser.add_argument('--test_model', default='attention', help='model selected to test')
    #### Training Hyperparams ####
    arg_parser.add_argument('--batch_size', default=50, type=int, help='Batch size')
    arg_parser.add_argument('--test_batch_size', default=200, type=int, help='Test batch size')
    arg_parser.add_argument('--lr', type=float, default=1e-4, help='learning rate')
    arg_parser.add_argument('--max_epoch', type=int, default=100, help='terminate after maximum epochs')
    #### Common Encoder Hyperparams ####
    arg_parser.add_argument('--encoder_cell', default='RNN', choices=['LSTM', 'GRU', 'RNN'], help='root of data')
    ...
    arg_parser.add_argument('--attention_size', default=1024, type=int, help='attention size')
    return arg_parser